...

{
	...
	start_angle=180,
	end_angle=360,
	bg_colour1={{0.,0xffffff,1.},{0.1,0xffffff,1.},{1,0x585858,01.}},
--	fg_colour1={{0,0x303030,1.},{1,0x020202,01.}},
	fg_colour1={{0.1,0xffffff,1.},{1,0x585858,01.}},
...

{
	...
	start_angle=180,
	end_angle=360,
	bg_colour1={{0.1,0x585858,1.},{1,0xffffff,1.},{0.9,0xffffff,1.}},
--	fg_colour1={{0.1,0x020202,01.},{1,0x303030,1.}},
	fg_colour1={{0.1,0x585858,1.},{1,0xffffff,1.}},
...

{
	...
	start_angle=180,
	end_angle=360,
	bg_colour1={{0.,0x585858,01.},{0.45,0xFFFFFF,1.},{0.55,0xFFFFFF,1.},{1,0x585858,01.}},
--	fg_colour1={{0,0x020202,01.},{0.5,0x303030,1},{1,0x020202,01.}},
        fg_colour1={{0.,0x585858,01.},{0.5,0xFFFFFF,1.},{1,0x585858,01.}},
