...
--graphe cpu  
	...
	x=85,
        ...
        nb_values=20,
        fg_bd_size=2,
        bg_colour = { {0.,0x585858,01.},{0.45,0xFFFFFF,1.},{0.55,0xFFFFFF,1.},{1,0x585858,01.}},
        fg_bd_colour = { {0,0xDCDCDC,.8},{0.5,0x808080,.8},{1,0x303030,.8}},
        foreground=false,
	inverse=false,
	    },
    {
	...
	x=85,
        ...
        nb_values=20,
        fg_bd_size=2,
        bg_colour = {{0.,0x808080,0.1},{0.5,0x808080,.4},{1,0x808080,0.}},
        fg_bd_colour = {{0,0xDCDCDC,.8},{0.5,0x808080,.8},{1,0x303030,.8}},
        foreground=false,
	background=false,
	inverse=false,
