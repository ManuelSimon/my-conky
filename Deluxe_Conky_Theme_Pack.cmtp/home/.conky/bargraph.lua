--this widget is modified to accept parameter table_settings: conky_main_bars(table_settings)
...
----------------START OF PARAMETERS ----------
function conky_main_bars(table_settings)
    local bars_settings=table_settings
	--[[local bars_settings={
		{
			name="time",
			arg="%S",
